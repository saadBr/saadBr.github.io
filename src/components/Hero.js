  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-6">
        ...
        <a
          href="https://www.linkedin.com/in/saadelmabrouk/"
          target="_blank"
          rel="noopener noreferrer"
          className="text-gray-400 hover:text-yellow-400 text-3xl transition"
        >
        ...
        <a
          href="mailto:saadelmabrouk18@gmail.com" 
          className="text-gray-400 hover:text-yellow-400 text-3xl transition"
        >
          <FaEnvelope />
        </a>
        ...
        <a
          href="https://www.credly.com/users/saad-el-mabrouk/" 
          target="_blank"
          rel="noopener noreferrer"
          className="text-gray-400 hover:text-yellow-400 text-3xl transition"
        >
